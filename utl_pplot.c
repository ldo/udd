...
int fni
  ...
  /* analyze room into u.i */
  {
    ...
    r = r >> 2;
    if (u.c[UC_SPELL_LIGHT] < 1 && u.i[3] == 3 && rnd() < 0.85)
      u.i[3] = 1;
    if (u.c[UC_SPELL_LIGHT] < 1 && u.i[4] == 3 && rnd() < 0.85)
      u.i[4] = 1;
    u.i[5] = (r & 15);                   /* special */
    r = r >> 4;
    u.i[6] = (r & 1);
...
int fni1
  ...
  /* analyze into u.i1 */
  {
    ...
    u.i1[2] = u.i1[4] = (r & 3);
    r = r >> 2;
    if (u.c[UC_SPELL_LIGHT] < 1 && u.i1[3] == 3 && rnd() < 0.85)
      u.i1[3] = 1;
    if (u.c[UC_SPELL_LIGHT] < 1 && u.i1[4] == 3 && rnd() < 0.85)
      u.i1[4] = 1;
    u.i1[5] = (r & 15);
    r = r >> 4;
    u.i1[6] = (r & 1);
